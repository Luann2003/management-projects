...
public interface TaskRepository extends JpaRepository<Task, Long> {
	...
	@Query("SELECT new com.managementprojects.entities.Task"
			+ "(task.id, task.startDate, task.finishDate, task.description, task.name, task.project, task.responsible, task.completed) " +
		       "FROM Task task "
